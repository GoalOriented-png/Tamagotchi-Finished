...
*/
 ...
 if (statArray.weight > 20) {
   statArray.weight = 20
     ...
     /// actual stuff DELETE THE DOCUMENT BY SHOWTIME [param, where, statName, finalBar, extra, zero] Zero is the 0 bar, and extra is the extras locations.
 ...
 function displayBarStats(param, where, statName, finalBar, extra, zero, classVariable) {
 
   if (param === 0) {
     document.querySelector(where).innerHTML = `${zero}`
   } else if (param > 0 && param <= 1) {
     document.querySelector(where).innerHTML = `<img class="image-bar ${classVariable}" src="images/Bars/${statName}Bar.png">`
   } else if (param > 1 && param <= 2) {
 document.querySelector(where).innerHTML = `<img class="image-bar ${classVariable}" src="images/Bars/${statName}Bar (1).png">`
   } else if (param > 2 && param <= 3) {
 document.querySelector(where).innerHTML = `<img class="image-bar ${classVariable}" src="images/Bars/${statName}Bar (2).png">`
   } else if (param > 3 && param <= 4) {
 document.querySelector(where).innerHTML = `<img class="image-bar ${classVariable}" src="images/Bars/${statName}Bar (3).png">`
   } else if (param > 4 && param <= 5) {
 document.querySelector(where).innerHTML = `<img class="image-bar ${classVariable}" src="images/Bars/${statName}Bar (4).png">`
   } else if (param > 5 && param <= 6) {
 document.querySelector(where).innerHTML = `<img class="image-bar ${classVariable}" src="images/Bars/${statName}Bar (5).png">`
   } else if (param > 6 && param <= 7) {
 document.querySelector(where).innerHTML = `<img class="image-bar ${classVariable}" src="images/Bars/${statName}Bar (6).png">`
   } else if (param > 7 && param <= 8) {
 document.querySelector(where).innerHTML = `<img class="image-bar ${classVariable}" src="images/Bars/${statName}Bar (7).png">`
   } else if (param > 8 && param <= 9) {
 document.querySelector(where).innerHTML = `<img class="image-bar ${classVariable}" src="images/Bars/${statName}Bar (8).png">`
   } else if (param > 9 && param <= 10) {
 document.querySelector(where).innerHTML = `<img class="image-bar ${classVariable}" src="images/Bars/${statName}Bar (9).png">`
   } else {
